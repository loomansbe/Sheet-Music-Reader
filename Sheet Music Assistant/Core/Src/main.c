...
/* Definitions for displayNoteLett */
osThreadId_t displayNoteLettHandle;
const osThreadAttr_t displayNoteLett_attributes = {
  .name = "displayNoteLett",
  .priority = (osPriority_t) osPriorityNormal,
  .stack_size = 128 * 4
};
/* USER CODE BEGIN PV */
...
/* USER CODE BEGIN Header_StartButtonPoll */
/**
...
/* USER CODE BEGIN Header_StartDisplayImage */
/**
* @brief Function implementing the displayImage thread.
* @param argument: Not used
* @retval None
*/
...
/* USER CODE BEGIN Header_StartDisplayNoteLetters */
/**
* @brief Function implementing the displayNoteLett thread.
* @param argument: Not used
* @retval None
*/
...
void StartDisplayNoteLetters(void *argument)
{
  ...
  /* USER CODE END StartDisplayNoteLetters */
}
